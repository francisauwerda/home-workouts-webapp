...
const WorkoutDetailsPage = () => {
  ...
  if (loading) return <ScreenWrapper><p>Loading...</p></ScreenWrapper>
  if (error) return <ScreenWrapper><p>Error :(</p></ScreenWrapper>
  
  const workout: Workout = data.workouts.find((workout: Workout) => workout.id === workoutId)
  if (!workout || !workoutId) return <ScreenWrapper><p>No workout found</p></ScreenWrapper>
